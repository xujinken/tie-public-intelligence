...
**关于**：硬科技外视角（Hardtech Outside View）是一个基于公开信息的硬科技产业观察项目。我们站在企业外面，追踪"从内部不太容易看到"的外部信号。联系：sparrow.xujin@gmail.com
...
| 关键陈述 | 层级 | 说明 |
|---------|------|------|
| 华润微/士兰微涨价15%+、订单能见度9个月 | 二级 | 行业媒体引述厂商调价函 |
| 传感器芯片交期26周、模组订单+37% | 二级 | 中文媒体引述TechInsights一级研究机构报告 |
| 全球市场$4.7B、Top 5占63%、各厂商营收 | 三级 | 行业研究机构估算（MarketResearch/ReportPrime） |
| 原极FSS-IMU614E-S参数 | **一级** | 制造商官网技术规格书，可独立核验 |
| 汉威HAU925芯片发布 | 二级 | 媒体报道产品发布事件 |
| 每台机器人需2-8个IMU | 推断 | 作者基于公开BOM分析估算 |
| 2026年出货预计5万台 | 二级 | 媒体引述IDC预测数据 |
| **标定产能是真正瓶颈** | **推断** | 作者基于MEMS制造工艺流程的物理约束分析，非已报道事实，欢迎反驳 |

**层级定义**：一级=一手公开资料（官网/公告/政府文件），二级=研究机构数据经媒体转述，三级=行业估算，推断=作者分析结论。

**未核验项**：Bosch/ST/TDK机器人客户产能分配比例、国产IMU标定设备供应商产能、华依科技ARU系列实际定点合同状态。
